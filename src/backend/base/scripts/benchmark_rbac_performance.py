...
from langflow.services.rbac.permission_engine import PermissionEngine, PermissionResult, PermissionDecision
...
class PerformanceBenchmark:
    ...
    def create_mock_user(self, user_id: Optional[str] = None):
