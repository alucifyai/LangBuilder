...
class Flow(FlowBase, table=True):  # type: ignore[call-arg]
    ...
    user_id: UUIDstr | None = Field(index=True, foreign_key="user.id", nullable=True)
    ...
    # RBAC relationships
    project_id: UUIDstr | None = Field(default=None, foreign_key="project.id", nullable=True, index=True)
