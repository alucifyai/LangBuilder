...
from sqlalchemy import JSON, Column, Text, UniqueConstraint, Index
...
class RoleAssignment(RoleAssignmentBase, table=True):  # type: ignore[call-arg]
    ...
    group: Optional["UserGroup"] = Relationship(back_populates="role_assignments")
    workspace: Optional["Workspace"] = Relationship(back_populates="role_assignments")
    project: Optional["Project"] = Relationship(back_populates="role_assignments")
    environment: Optional["Environment"] = Relationship(back_populates="role_assignments")
    flow: Optional["Flow"] = Relationship(back_populates="role_assignments")
