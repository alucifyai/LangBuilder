...
export const useGetSimpleProjects: useMutationFunctionType<
  undefined,
...
> = (options?) => {
  ...
  async function getProjects({
    ...
    let url = `${getURL("RBAC")}/simple-projects/?page=${page}&page_size=${page_size}`;
  ...
  const mutation: UseMutationResult<
    ...
    any,
    GetProjectsQueryParams
  > = mutate(["useGetSimpleProjects"], getProjects, options);
