...
export const useGetSimpleWorkspaces: useMutationFunctionType<
  undefined,
...
> = (options?) => {
  ...
  async function getWorkspaces({
    ...
    let url = `${getURL("RBAC")}/simple-workspaces/?page=${page}&page_size=${page_size}`;
  ...
  const mutation: UseMutationResult<
    ...
    any,
    GetWorkspacesQueryParams
  > = mutate(["useGetSimpleWorkspaces"], getWorkspaces, options);
