...
describe('Phase 6 RBAC Frontend Integration', () => {
  ...
  describe('RBAC Admin Dashboard', () => {
    it('should render the main RBAC admin page with navigation', () => {
      ...
      expect(screen.getByText('Role-Based Access Control management for LangBuilder')).toBeInTheDocument();
    });
  ...
  describe('Workspace Management', () => {
    ...
    it('should display workspace list', async () => {
      ...
      vi.mocked(require('@/controllers/API/queries/rbac').useGetWorkspaces).mockReturnValue({
    ...
    it('should handle workspace creation', async () => {
      ...
      vi.mocked(require('@/controllers/API/queries/rbac').useCreateWorkspace).mockReturnValue({
  ...
  describe('Permission Guard Component', () => {
    it('should render children when permission is granted', async () => {
      ...
      vi.mocked(require('@/controllers/API/queries/rbac').useCheckPermission).mockReturnValue({
    ...
    it('should show loading state while checking permission', () => {
      const mockCheckPermission = vi.fn().mockImplementation(() => new Promise(() => {}));
