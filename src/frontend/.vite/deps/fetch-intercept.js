...
var require_browser = __commonJS({
  "node_modules/fetch-intercept/lib/browser.js"(exports, module) {
    module.exports = /******/
    function(modules) {
      ...
      function(module2, exports2, __webpack_require__) {
        ...
        module2.exports = attach(ENVIRONMENT_IS_WORKER ? self : window);
      },
      /* 1 */
      /***/
      function(module2, exports2, __webpack_require__) {
        ...
        module2.exports = function attach(env) {
          if (!env.fetch) {
            try {
          ...
          env.fetch = /* @__PURE__ */ function(fetch2) {
            return function() {
      ...
      function(module2, exports2) {
        module2.exports = (init_fetch(), __toCommonJS(fetch_exports));
      }
      /******/
    ]);
  }
